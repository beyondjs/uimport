module.exports = class {
    ...
    get external() {
        ...
        return this.#external = new (require('./external'))(this, this.#absWorkingDir);
    }
     ...
     * @param absWorkingDir {object} The working directory
     */
    constructor(inputs, input, meta, ims, absWorkingDir) {
        this.#input = input;
        this.#meta = meta;
        this.#ims = ims;
        this.#absWorkingDir = absWorkingDir;

        const [root, resource] = input
            .replace(input.startsWith('node_modules/') ? 'node_modules/' : '/node_modules/', '//')
            .split('//');
