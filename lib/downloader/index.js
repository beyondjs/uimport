...
module.exports = class {
    ...
    async #fetch() {
        ...
        const done = error => file.close(() => {
            error ? console.log(`Error downloading package "${name}@${version}": ${error.message}`) :
                console.log(`Package "${name}@${version}" was downloaded`);
        ...
        console.log(`Downloading package "${name}@${version}" ...`);
