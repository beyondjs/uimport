...
module.exports = class extends Map {
    ...
    find(path) {
        ...
        const subpackage = [...this.#subpackages].find(([, subpackage]) => subpackage.file === path);

        // @TODO: Remove the commented line
        // path === './styles/zIndex.js' && console.log('subpackage', path, subpackage, this.subpackages.get('styles').file);
        return subpackage;
    }
}
