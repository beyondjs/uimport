...
module.exports = async function (bundle, version, mode, UISpecs) {
    ...
    code = (() => {
        const {versions} = UISpecs;
        const dependencies = new (require('./dependencies'))(metafile, versions);
        const script = require('./module')(code);
        return require('./mformat')(mode, script, dependencies, exports, reexports, versions);
    })();
