module.exports = class extends Map {
    ...
    get register() {
        ...
        return `typeof uimport === 'function' && uimport.bundles.register("${this.#name}", ${dependencies});\n\n`;
    }
    ...
    constructor(metafile) {
        ...
        this.#name = `${metafile.bundle}@${metafile.version}`;
        ...
        this.#code = (() => {
            ...
            const entries = [...this].map(([dependency, param]) => `['${dependency.replace(regExp, '')}', ${param}]`);
