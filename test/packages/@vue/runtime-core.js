define(["@vue/shared","@vue/reactivity"], (dep_0, dep_1) => {
    const dependencies = new Map([['@vue/shared', dep_0],['@vue/reactivity', dep_1]]);
            ...
            if ((0, import_shared.isFunction)(ref3)) {
                ...
                if (_isString || _isRef) {
                    const doSet = () => {
                        ...
                        } else if ((0, import_reactivity.isRef)(ref3)) {
                            ref3.value = value;
...
For more details, see https://link.vuejs.org/feature-flags.`);
        ...
        function baseCreateRenderer(options, createHydrationFns) {
            ...
            const setupRenderEffect = (instance, initialVNode, container, anchor, parentSuspense, isSVG, optimized) => {
                ...
                const effect2 = instance.effect = new import_reactivity.ReactiveEffect(componentUpdateFn, () => queueJob(instance.update), instance.scope);
...
Component that was made reactive: `, type);
        ...
        var publicPropertiesMap = (0, import_shared.extend)( /* @__PURE__ */Object.create(null), {
            $: i => i,
            $el: i => i.vnode.el,
            $data: i => i.data,
        ...
        var PublicInstanceProxyHandlers = {
            get({
                ...
                if (publicGetter) {
                    ...
                    if (data !== import_shared.EMPTY_OBJ && (key[0] === "$" || key[0] === "_") && (0, import_shared.hasOwn)(data, key)) {
        ...
        function getComponentName(Component) {
            return (0, import_shared.isFunction)(Component) ? Component.displayName || Component.name : Component.name;
        }
