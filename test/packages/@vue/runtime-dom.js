define(["@vue/shared","@vue/reactivity","@vue/runtime-core"], (dep_0, dep_1, dep_2) => {
    const dependencies = new Map([['@vue/shared', dep_0],['@vue/reactivity', dep_1],['@vue/runtime-core', dep_2]]);
    ...
    const code = (module, require) => {
        ...
        function patchDOMProp(el, key, value, prevChildren, parentComponent, parentSuspense, unmountChildren) {
            ...
            if (value === "" || value == null) {
                ...
                if (type === "boolean") {
                    el[key] = (0, import_shared.includeBooleanAttr)(value);
                    return;
        ...
        var rendererOptions = (0, import_shared.extend)({
            patchProp
        }, nodeOps);
        var renderer;
...
- For vite: pass it via @vitejs/plugin-vue options. See https://github.com/vitejs/vite/tree/main/packages/plugin-vue#example-for-passing-options-to-vuecompiler-dom`;
        ...
        __reExport(input_exports, runtime_dom_esm_bundler_exports);
